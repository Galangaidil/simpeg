...
setTimeout(() => loading.showAlert = false, 5000);
                            ...
                            <div class="w-full md:w-1/3 px-4 py-2">
                                ...
                                <div v-if="loading.showAlert" class="flex p-4 my-2 bg-green-100 rounded-lg" role="alert">
                                    <div class="ml-3 text-sm font-medium text-green-700">
                                        Anda dapat menekan tombol <strong class="uppercase">Isi Cepat</strong> untuk mengisi latitude dan longitude secara otomatis. Anda juga dapat mengisinya dengan mengetuk maps.
                                    </div>
                                ...
                                <div class="flex justify-end mb-2">
                                    <PrimaryButton @click="getCurrentLocation" class="flex items-center">
                                        ...
                                        <span v-if="loading.OnLoading">Mengisi</span>
                                        <span v-else>Isi Cepat</span>
                                    </PrimaryButton>
                                </div>
