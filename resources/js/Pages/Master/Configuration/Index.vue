            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <div class="max-w-2xl">
                            <h1 class="mb-4 text-xl font-extrabold tracking-tight leading-none text-gray-900 md:text-2xl lg:text-3xl">
                                Pengaturan
                            </h1>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="text-gray-900 font-semibold">{{ formatSalary.format(props.configuration.salary) }}</div>
                        </div>
                        <div class="mt-4">
                        ...
                        <div class="mt-4">
                            <div class="text-gray-500 text-sm">Jarak yang diterima untuk melakukan presensi</div>
                            <div class="text-gray-900 font-semibold">{{ props.configuration.accepted_distance }} meter</div>
                        </div>
